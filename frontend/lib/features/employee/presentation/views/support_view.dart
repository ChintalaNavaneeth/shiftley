...
class _SupportViewState extends State<SupportView> {
  ...
  final List<Map<String, dynamic>> _allTickets = [
    {'id': 'TKT-9912', 'subject': 'Payment not received for Sunday shift', 'status': 'IN PROGRESS', 'color': Colors.blue},
    {'id': 'TKT-9850', 'subject': 'Unable to check-in at location', 'status': 'RESOLVED', 'color': Colors.green},
    {'id': 'TKT-9721', 'subject': 'KYC verification pending for 3 days', 'status': 'RESOLVED', 'color': Colors.green},
  ];
      ...
      children: [
        ...
        Expanded(
          child: ListView(
            ...
            children: [
              _buildChatBubble(
                'Hi there! We have received your query regarding the Sunday shift payment. We are verifying it with the employer.',
                isSupport: true,
                time: '09:00 AM',
              ),
              _buildChatBubble(
                'Thanks for the quick response. The employer confirmed the shift on their end too.',
                isSupport: false,
                time: '09:15 AM',
              ),
            ],
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            STextField(hint: 'Subject (e.g. Payment Issue)', controller: TextEditingController()),
            const SizedBox(height: ShiftleyTokens.spaceM),
