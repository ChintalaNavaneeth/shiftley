...
class _SupportViewState extends State<SupportView> {
  ...
  final List<Map<String, dynamic>> _allTickets = [
    {'id': 'AUD-102', 'subject': 'Location mismatch error at Banjara Hills', 'status': 'IN PROGRESS', 'color': Colors.blue},
    {'id': 'AUD-098', 'subject': 'Employer refused signage photo', 'status': 'RESOLVED', 'color': Colors.green},
  ];
  ...
  Widget _buildListView() {
    ...
    return Column(
      ...
      children: [
        const Text('Field issues or technical glitches? Our ops team is here to help.', style: ShiftleyTokens.bodyMedium),
        const SizedBox(height: ShiftleyTokens.spaceXL),

        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            const Text('Auditor Support', style: ShiftleyTokens.h2),
            ShiftleyButton(
              label: 'Raise Ticket', 
  ...
  void _showRaiseTicketDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: const Text('Report Field Issue', style: ShiftleyTokens.h2),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text('Describe the issue in the field', style: ShiftleyTokens.caption),
            const SizedBox(height: 8),
            STextField(hint: 'Subject (e.g. GPS Mismatch)', controller: TextEditingController()),
            const SizedBox(height: ShiftleyTokens.spaceM),
            const Text('Details', style: ShiftleyTokens.caption),
            const SizedBox(height: 8),
            STextField(hint: 'Provide details about the business or technical error...', controller: TextEditingController(), maxLines: 4),
          ],
        ),
        actions: [
